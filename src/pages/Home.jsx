...
const Home = () => {
  ...
  <p className="relative z-10 text-base sm:text-lg md:text-2xl mb-6 md:mb-8 max-w-xl mx-auto text-[#121416] text-center animate-fade-in-up delay-200">Compra seguro, rápido y con atención personalizada. ¡Tu próximo vehículo te espera!</p>
  <a href="/inventario" className="relative z-10 inline-block bg-[#3498DB] hover:bg-[#323A43] text-white font-bold py-3 px-8 md:py-4 md:px-14 rounded-xl text-lg md:text-2xl shadow-xl transition-all duration-200 scale-100 hover:scale-105 animate-fade-in-up delay-300">Ver inventario</a>
      </header>
